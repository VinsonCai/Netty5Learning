...
final class DefaultChannelHandlerContext extends DefaultAttributeMap implements ChannelHandlerContext {
	...
	/**
	 * Returns an integer bitset that tells which handler methods were annotated with {@link Skip}. It gets the value
	 * from {@link #skipFlagsCache} if an handler of the same type were queried before. Otherwise, it delegates to
	 * {@link #skipFlags0(Class)} to get it.
	 */
